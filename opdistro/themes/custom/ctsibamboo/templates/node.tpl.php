...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"
  ...
  <?php // omit the "else if (title) print H1" from Bamboo base theme ?>
  <?php endif; ?>
...
<?php if ($display_submitted): ?>
  <div id="submit-wrapper">
    ...
    <span class="submitted"><?php print $submitted; ?> on <?php print $themonth;  ?> <?php print $thedate;  ?>, <?php print $theyear; ?></span>

    <!-- Then show the date in parts for better theming. DISABLED 
